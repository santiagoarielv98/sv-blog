...
export default function MostUsedTags() {
  ...
  return (
    ...
    <main className="container mx-auto px-4 py-8">
          ...
          <CardContent>
            <div className="flex flex-wrap gap-2">
              {[
                ...
                { name: "Web Development", size: "text-base", weight: "font-normal" },
                { name: "Data Science", size: "text-xl", weight: "font-semibold" },
                { name: "Machine Learning", size: "text-lg", weight: "font-medium" },
                { name: "Cybersecurity", size: "text-base", weight: "font-normal" },
                { name: "Cloud Computing", size: "text-lg", weight: "font-medium" },
                { name: "IoT", size: "text-base", weight: "font-normal" },
                { name: "Blockchain", size: "text-base", weight: "font-normal" },
              ].map((tag, index) => (
                <Link
                  key={index}
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">Recent Posts by Popular Tags</h2>

      ...
      <div className="flex flex-col md:flex-row gap-8">
        <article className="md:w-2/3">
          ...
          <div className="flex items-center space-x-4 mb-6 text-muted-foreground">
            <div className="flex items-center">
              <Avatar className="h-8 w-8 mr-2">
                ...
                <AvatarFallback className="uppercase">{post?.author.username.slice(0, 2)}</AvatarFallback>
              </Avatar>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {
              post?.tags.map((tag) => (
                <Button className="capitalize" variant="outline" size="sm" key={tag.id} asChild>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-4">
                {['The Ethics of AI', 'Machine Learning Basics', 'AI in Healthcare'].map((post, index) => (
                  <li key={index} className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">May {15 + index}, 2023</p>
                    </div>
                  </li>
                ))}
              </ul>
